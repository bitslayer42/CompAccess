...
<cfif NOT Isdefined("form.EmpID")>
  ...
  <div style="display:flex;flex-direction: column;align-items: center;">
    ...
    <iframe width="800" height="130" marginheight="0" marginwidth="0" frameborder="0" name="thetopper" scrolling="no" src="https://ccp1.msj.org/topbottom/thetop.cfm"></iframe><br>

    <div>
    <b>Computer Access Form Reports</b>
    </div>
    <div id="loading" style="color:orange;"></div>
    ...
    <br><iframe width="800" height="35" marginheight="0" marginwidth="0" frameborder="0" name="thebottomer" scrolling="no" src="https://ccp1.msj.org/topbottom/thebottom.cfm"></iframe>
